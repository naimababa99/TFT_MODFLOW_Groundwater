...
def run_enhanced_modflow_pipeline(
    ...
    trend_info = modflow_prep.analyze_trend(observed_head_m, df[date_col].values)
...
if __name__ == "__main__": 
    ...
    simulated, observed, metrics, params = run_enhanced_modflow_pipeline(
        data_path=r'C:/Users/naima/Desktop/MODFLOW/Model/data/engineered/engineered_dataset.csv',
        model_dir=r'C:/Users/naima/Desktop/MODFLOW/Model/models/modflow_enhanced',
        target_col='water_level',
        date_col='date',
        train_end='2021-12-31',
        val_end='2023-12-31',
        exe_name=r'C:/Users/naima/Desktop/MODFLOW/MF2005.1_12/MF2005.1_12/bin/mf2005.exe',
